...
// Set the I2C device address
   ...
   rc_i2c_set_device_address(SERVO_I2C_BUS, SERVO_I2C_ADDR) ;

// Write to MODE1 register

   rc_i2c_write_byte(SERVO_I2C_BUS, PCA9685_MODE1, 0x00) ;
...
// Need to read current mode
   ...
   rc_i2c_read_byte(SERVO_I2C_BUS, PCA9685_MODE1, rd_buf) ;
   old_mode = rd_buf[0] ;
   new_mode = (old_mode & 0x7f) | 0x10 ; // sleep mode

// Write out new mode and put PCA9685 to sleep

   rc_i2c_write_byte(SERVO_I2C_BUS, PCA9685_MODE1, new_mode) ;

//  Write out the prescaler value

   rc_i2c_write_byte(SERVO_I2C_BUS, PCA9685_PRESCALE, pre_scale_value) ;

// Restore old mode setting

   rc_i2c_write_byte(SERVO_I2C_BUS, PCA9685_MODE1, old_mode) ;
...
// Turn on auto increment
   ...
   rc_i2c_write_byte(SERVO_I2C_BUS, PCA9685_MODE1, (old_mode | 0xa1) ) ;   
...
// Pulse turned off when counter equals ...
   ...
   rc_i2c_write_bytes(SERVO_I2C_BUS, wr_buf[0], 4, &wr_buf[1]) ;
